...
export function Header(props: HeaderProps) {
  ...
  return (
    <Navbar expand="lg" variant="light" bg="white" className="border-bottom border-light py-0" onToggle={() => setTogglerClassname("")} {...(props._editable ? {...storyblokEditable(props as any)} : {})}>
